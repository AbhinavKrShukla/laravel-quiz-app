        ...
        <div class="content">
            ...
            <div class="module">
                ...
                <div class="module-body">
                    ...
                    <form class="form-horizontal row-fluid" method="post" action="{{route('question.store')}}"> @csrf
                        ...
                        <div class="control-group @error('question') alert alert-error @enderror">
                            ...
                            <div class="controls">
                                <input name="question" type="text" id="basicinput" placeholder="Question..." class="span10" value="{{old('question')}}" required><br>
                                @error('question')
                                    <span class="text-error">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                @for($i=0; $i<4; $i++)
                                    <input name="options[]" id="options" type="text" placeholder="Option {{$i+1}}..." class="span8 border-red" value="{{old('options.[$i]')}}" style="margin-top:10px;">
                                    <input type="radio" name="correct_answer" value="{{$i}}"><span class="help-inline">Is Correct</span><br>
                                    @error('option'.$i)
